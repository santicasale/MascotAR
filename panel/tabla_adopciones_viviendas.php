      ...
      <table border="1" cellpadding="10" cellspacing="0" style="margin:auto; background:white; border-collapse:collapse; width:90%;">
        ...
        <?php while ($row = $res->fetch_assoc()): ?>
          <tr>
            ...
            <td>
              <a href="editar_adopt_vivienda.php?Id=<?php echo $row['id_vivienda']; ?>" class="btn-table btn-warning">Editar</a>
              <a href="eliminar_adopt_vivienda.php?Id=<?php echo $row['id_vivienda']; ?>" class="btn-table btn-danger">Eliminar</a>
            </td>
          </tr>
        <?php endwhile; ?>
      </table>
