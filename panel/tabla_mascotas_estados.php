...
$sql = "SELECT * FROM mascota_estado ORDER BY id_pet_status ASC";
$res = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="es">
      ...
      <table border="1" cellpadding="10" cellspacing="0" style="margin:auto; background:white; border-collapse:collapse; width:90%;">
        ...
        <?php while ($row = $res->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="editar_mascota_estado.php?id=<?php echo $row['id_pet_status'] ?>" class="btn btn-warning">Editar</a>
                    <a href="eliminar_mascota_estado.php?id=<?php echo $row['id_pet_status'] ?>" class="btn btn-danger">Eliminar</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
