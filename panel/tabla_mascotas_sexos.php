      ...
      <table border="1" cellpadding="10" cellspacing="0" style="margin:auto; background:white; border-collapse:collapse; width:90%;">
        ...
        <?php while ($row = $res->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="editar_mascota_sexo.php?id=<?php echo $row['id_pet_sex'] ?>" class="btn-table btn-warning">Editar</a>
                    <a href="eliminar_mascota_sexo.php?id=<?php echo $row['id_pet_sex'] ?>" class="btn-table btn-danger">Eliminar</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
